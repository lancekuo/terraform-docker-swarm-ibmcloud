...
resource "null_resource" "storage_trigger" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            "echo '====== Metric Storage =====';if [ -d /mnt/prometheus ];then echo \"=> The directory has existed.\";else sudo mkdir /mnt/prometheus;sudo chmod 777 /mnt/prometheus;echo \"prometheus directory created.\";fi",
            "umount /mnt",
            "mount ${ibm_storage_file.logs.mountpoint} /mnt",
            "echo '======Logs Storage=====';if [ -d /mnt/elasticsearch ];then echo \"=> The directory has existed.\";else sudo mkdir /mnt/elasticsearch;sudo chmod 777 /mnt/elasticsearch;echo \"elasticsearch directory created.\";fi",
            "umount /mnt",
            ...
            "echo '====== PSQLStorage =====';if [ -d /mnt/data/postgresql ];then echo \"=> The directory has existed.\";else sudo mkdir -p /mnt/data/postgresql;sudo chmod 777 /mnt/data/postgresql;echo \"PSQL directory created.\";fi",
            "umount /mnt",
        ]
        connection {
