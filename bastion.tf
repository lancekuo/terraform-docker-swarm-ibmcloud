...
resource "ibm_compute_ssh_key" "nat" {
  label      = "${var.rsa_key_nat["key_name"]}.${var.project}.${terraform.workspace}.${var.domain}"
...
resource "ibm_compute_ssh_key" "bastion" {
  label      = "${var.rsa_key_bastion["key_name"]}.${var.project}.${terraform.workspace}.${var.domain}"
  notes      = "${var.project}.${terraform.workspace}.${var.domain}"
